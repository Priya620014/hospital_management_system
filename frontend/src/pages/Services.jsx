        ...
        {diagnosticServices.map((service, index) => (
          <div key={index} className="bg-white rounded-[2.5rem] p-6 shadow-sm border border-slate-50 hover:shadow-2xl transition-all duration-300 group">
            ...
            <div className="relative mb-6 overflow-hidden rounded-[2rem] h-56 bg-teal-50 flex items-center justify-center">
              {/* If you have images, use <img> tag; otherwise, use icons as placeholders */}
            ...
            <div className="text-center px-4">
              ...
              <button className="w-full flex items-center justify-center gap-3 bg-gradient-to-r from-[#10b981] to-[#34d399] text-white py-4 rounded-full font-black text-lg hover:shadow-lg hover:opacity-90 transition-all">
